...
def run_linear(
    ...
    from cs336_basics.components import Linear
...
def run_embedding(
    ...
    """
    from cs336_basics.components import Embedding
...
def run_swiglu(
    ...
    """
    from cs336_basics.components import SwiGLU
...
def run_scaled_dot_product_attention(
    ...
    """
    from cs336_basics.components import scaled_dot_product_attention
...
def run_multihead_self_attention(
    ...
    """
    from cs336_basics.components import MultiHeadSelfAttention

    mha = MultiHeadSelfAttention(d_model, num_heads, device=q_proj_weight.device, dtype=q_proj_weight.dtype)
...
def run_multihead_self_attention_with_rope(
    ...
    mha = MultiHeadSelfAttention(
        d_model, num_heads, theta=theta, max_seq_len=max_seq_len, device=q_proj_weight.device, dtype=q_proj_weight.dtype
    )
    mha.q_proj.weight.data = q_proj_weight
    mha.k_proj.weight.data = k_proj_weight
    mha.v_proj.weight.data = v_proj_weight
...
def run_rope(
    ...
    """
    from cs336_basics.components import RoPE
...
def run_transformer_block(
    ...
    """
    from cs336_basics.components import Block

    block = Block(d_model, num_heads, d_ff, max_seq_len, theta, device=in_features.device, dtype=in_features.dtype)
...
def run_rmsnorm(
    ...
    """
    from cs336_basics.components import RMSNorm
...
def run_silu(in_features: Float[Tensor, " ..."]) -> Float[Tensor, " ..."]:
    ...
    """
    from cs336_basics.components import SiLU
...
def run_get_batch(
    ...
    """
    from cs336_basics.train_util import get_batch
...
def run_cross_entropy(
    ...
    """
    from cs336_basics.train_util import cross_entropy
...
def run_gradient_clipping(parameters: Iterable[torch.nn.Parameter], max_l2_norm: float) -> None:
    ...
    """
    from cs336_basics.train_util import gradient_clipping
...
def get_adamw_cls() -> Any:
    ...
    """
    from cs336_basics.train_util import AdamW
    return AdamW
...
def run_get_lr_cosine_schedule(
    ...
    """
    from cs336_basics.train_util import get_lr_cosine_schedule
...
def run_save_checkpoint(
    ...
    """
    from cs336_basics.train_util import save_checkpoint
...
def run_load_checkpoint(
    ...
    """
    from cs336_basics.train_util import load_checkpoint
